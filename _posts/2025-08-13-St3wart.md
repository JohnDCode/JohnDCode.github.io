...
Now, using this command, we can craft the JSON object for this check.
...
Using this information, let's define the check.
...
These three checks yields the following JSON:
